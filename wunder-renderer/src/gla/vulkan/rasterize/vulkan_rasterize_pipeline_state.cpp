...
vulkan_rasterize_pipeline_state::vulkan_rasterize_pipeline_state(){
  ...
  m_color_blend_state.pAttachments    = {};
  for(int i = 0; i < 4; i++)
  {
  ...
  m_dynamic_state.pDynamicStates    = {};
  ...
  m_viewport_state.viewportCount = {};
  m_viewport_state.pViewports    = {};
  m_viewport_state.scissorCount  = {};
  m_viewport_state.pScissors     = {};
